...
def arg_parse():
    ...
    # Datasets parameters
    parser.add_argument('--data_dir', type=str, default='hw2_data/p2_data',
    ...
    parser.add_argument('--test_batch', default=5, type=int,
    ...
    parser.add_argument('--model', default='Improved Model', type=str,
        help="Model type")
    ...
    # for test
    parser.add_argument('--input_dir', type=str, default="hw2_data/p2_data",
